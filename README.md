...
[Paper](https://arxiv.org/abs/2501.12599) · [PDF](https://arxiv.org/pdf/2501.12599) · [Issues](https://github.com/StaryMoon/Kimi-k1-5-Unofficial/issues) · [Release](https://github.com/StaryMoon/Kimi-k1-5-Unofficial/releases)
...
<p align="center">
  <img src="assets/paper-preview.png" alt="Kimi-k1-5-Unofficial paper or project page preview" width="900">
</p>

<sub>Image source: public paper/project page screenshot, [Paper](https://arxiv.org/abs/2501.12599). Captured/organized on 2026-07-02. This repository is unofficial and is not affiliated with the paper authors.</sub>
...
| Venue / Source | Reasoning RL / arXiv 2025 |
| Focus | This repository organizes a PyTorch implementation for Kimi k1.5: Scaling Reinforcement Learning with LLMs, focusing on scaling reinforcement learning for long-context multimoda... |
...
This repository organizes a PyTorch implementation for **Kimi k1.5: Scaling Reinforcement Learning with LLMs**, focusing on scaling reinforcement learning for long-context multimodal language models. The codebase is structured like a standard research repository so that model components, configuration files, scripts, and evaluation utilities can be extended independently.
...
```bash
git clone https://github.com/StaryMoon/Kimi-k1-5-Unofficial.git
cd Kimi-k1-5-Unofficial
python -m venv .venv
...
```python
import torch
from kimi_k1_5_unofficial import ModelConfig, UnofficialModel, reconstruction_loss
...
```python
import torch
from kimi_k1_5_unofficial import UnofficialModel
...
|---|---|---|
| Main quantitative comparison | Main paper tables | [arXiv paper](https://arxiv.org/abs/2501.12599) |
| Ablation study | Experiment / ablation sections | [arXiv paper](https://arxiv.org/abs/2501.12599) |
| Qualitative examples | Main paper figures and appendix | [arXiv PDF](https://arxiv.org/pdf/2501.12599) |
...
```bibtex
@article{Kimik15_2025,
  title   = {Kimi k1.5: Scaling Reinforcement Learning with LLMs},
  author  = {Kimi Team and Angang Du and Bofei Gao and Bowei Xing and Changjiu Jiang and Cheng Chen and Cheng Li and Chenjun Xiao and others},
...
- Thanks to the authors of **Kimi k1.5: Scaling Reinforcement Learning with LLMs** for the original research.
...
pytorch, unofficial-implementation, reproduction, llm, reasoning, reinforcement-learning, kimi, long-context
